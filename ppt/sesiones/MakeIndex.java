...
public class MakeIndex {
    public static void main(String[] args) {
        final String baseUrl                = "https://stgoneira.github.io/fundamentos-programacion-java/ppt/sesiones/";

        File directorioActual               = new File(".");
        final String[] listadoArchivos      = directorioActual.list();
        final List<String> noInteresan      = Arrays.asList( new String[]{"MakeIndex.java", "README.md"} );
